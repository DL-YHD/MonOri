...
class Detect_Head(nn.Module):
    def __init__(self, cfg, in_channels):
        ...
        self.predictor = make_predictor(cfg, in_channels) # Base_Predictor
        # ============================================ # 
        self.loss_evaluator = make_loss_evaluator(cfg) # 创建损失函数
        self.post_processor = make_post_processor(cfg) # 创建模型回归头
        # ============================================ # 
