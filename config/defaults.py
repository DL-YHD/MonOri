...
_C.DATASETS.KEYPOINTS_NUM = 10
_C.DATASETS.DEPTH_MASK_NUM = 3
_C.DATASETS.KEYPOINT_LOCAL_OFFSETS_LOSS = True
_C.DATASETS.POISITION_LOSS = True
_C.DATASETS.USE_AREA = False
_C.DATASETS.USE_BOT_TOP_CENTERS = True
_C.DATASETS.USE_RIGHT_LEFT_CENTERS = False
...
# Normalization for backbone (2, 4, 8, 16)
